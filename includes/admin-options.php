...
QUIS SAGITTIS JUSTO. DONEC GRAVIDA, ARCU IN ALIQUET CONVALLIS</span>
   ...
   // HEADER
	...
	$options[] = array(
        ...
        $options[] = array(
		'name' => __('Social Media Link', 'onetone'),
		'desc' => __('', 'onetone'),
		'id' => 'social_media',
		'std' => 'body{margin:0px;}',
		'type' => '');
        $options[] = array(
		'name' => __('Facebook Link', 'onetone'),
		'desc' => __('add here facebook link', 'onetone'),
		'id' => 'facebook_link',
		'std' => '',
		'type' => 'text');
        $options[] = array(
		'name' => __('Twitter Link', 'onetone'),
		'desc' => __('add here twitter link', 'onetone'),
		'id' => 'twitter_link',
		'std' => '',
		'type' => 'text');
        $options[] = array(
		'name' => __('youtube Link', 'onetone'),
		'desc' => __('add here youtube link', 'onetone'),
		'id' => 'youtube_link',
		'std' => '',
		'type' => 'text');
		////HOME PAGE
